...
public class EntertainmentAdapter extends RecyclerView.Adapter<EntertainmentAdapter.ViewHolder> {
    ...
    public EntertainmentAdapter(Activity context, RealmList<NewsListModelDatum> data, AdapterItemClickListner listener) {
    ...
    public EntertainmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        @SuppressLint("InflateParams") View view = LayoutInflater.from(context).inflate(R.layout.entertainment_item_view, null);
        viewholder = new EntertainmentAdapter.ViewHolder(view);
        return viewholder;
    }

    @Override
    public void onBindViewHolder(@NonNull EntertainmentAdapter.ViewHolder holder, int i) {
        holder.itemView.setOnClickListener(v -> {
            listener.OnItemClick("videoClick", i);
        });
        ...
        if (data.get(i).getTitle() != null)
            holder.tv_text.setText(Html.fromHtml(data.get(i).getTitle() + ""));
...
//                Picasso.with(context).load(Constants.BASE_URl + "/" + data.get(i).getCoverImage()).into(holder.iv_image);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            iv_image = itemView.findViewById(R.id.iv_video);
